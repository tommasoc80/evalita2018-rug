...
#    espresso_train = '/home/p281734/projects/evalita2018-rug/Data/espresso-ita-hate.p'
    ...
    evalita_test = '/home/p281734/projects/evalita2018-rug/Data/Test/haspeede_TW-test.tsv'

    print('Reading in EVALITA training data...')
    Xtrain,Ytrain = read_corpus(FB_train)
    ...
    fname = 'evalita_rug_FB-TW_svm.txt.txt'
