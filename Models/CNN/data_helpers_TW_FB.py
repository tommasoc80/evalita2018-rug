...
def load_data_and_labels():
    ...
    samples, labels = [],[]
    with open('/home/p281734/projects/evalita2018-rug/Data/haspeede_TW-train.tsv','r', encoding='utf-8') as fi:
        for line in fi:
...
#    samples, labels, idx_espresso = add_espresso_data(samples, labels)
    ...
    test_sentences = []
    test_ids = []
    with open('/home/p281734/projects/evalita2018-rug/Data/Test/haspeede_FB-test.tsv','r', encoding='utf-8') as fi:
        for line in fi:
            data = line.strip().split('\t')
            # get sample
            Xtest.append(data[1])
