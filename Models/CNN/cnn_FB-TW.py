...
def load_data(data_source):
    ...
    x, y, vocabulary, vocabulary_inv_list, len_train, test_sentence, test_ids = data_helpers_FB_TW.load_data()
...
fname = 'evalita_rug_FB-TW_cnn.txt'
