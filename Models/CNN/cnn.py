...
from keras.layers import Dense, Dropout, Flatten, Input, MaxPooling1D, Convolution1D, Embedding, LeakyReLU
...
def load_data(data_source):
    assert data_source in ["local_dir", "/media/flavio/1554-26B0/THESIS EXPERIMENTS/CNN/CNN-1"], "Unknown data source"
...
if model_type == "CNN-static":
    ...
    z = Embedding(len(vocabulary_inv), embedding_dim, input_length=sequence_length, name="embedding")(model_input) #trainable=False
...
z = Dense(hidden_dims, activation="relu")(z)  # LeakyReLU(alpha=0.1)
